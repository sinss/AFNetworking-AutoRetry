...
{
    NSURLSessionDataTask *task = [self requestUrlWithAutoRetry:timesToRetry retryInterval:intervalInSeconds originalRequestCreator:^NSURLSessionDataTask *(void (^retryBlock)(NSURLSessionDataTask *, NSError *)) {
        return [self POST:URLString parameters:parameters progress:uploadProgress success:success failure:retryBlock];
    } originalFailure:failure];
    return task;
}
...
{
    NSURLSessionDataTask *task = [self requestUrlWithAutoRetry:timesToRetry retryInterval:intervalInSeconds originalRequestCreator:^NSURLSessionDataTask *(void (^retryBlock)(NSURLSessionDataTask *, NSError *)) {
        return [self POST:URLString parameters:parameters constructingBodyWithBlock:block progress:uploadProgress success:success failure:retryBlock];
    } originalFailure:failure];
    return task;
}
...
- (NSURLSessionDataTask *)GET:(NSString *)URLString
                   parameters:(NSDictionary *)parameters
                     progress:(nullable void (^)(NSProgress * _Nonnull))downloadProgress
                      ...
                      failure:(void (^)(NSURLSessionDataTask *task, NSError *error))failure
                    autoRetry:(int)timesToRetry {
    return [self GET:URLString parameters:parameters progress:nil success:success failure:failure autoRetry:timesToRetry retryInterval:0];
}
...
- (NSURLSessionDataTask *)POST:(NSString *)URLString
                    parameters:(NSDictionary *)parameters
                      progress:(nullable void (^)(NSProgress * _Nonnull))uploadProgress
                       ...
                       failure:(void (^)(NSURLSessionDataTask *task, NSError *error))failure
                     autoRetry:(int)timesToRetry {
    return [self POST:URLString parameters:parameters progress:uploadProgress success:success failure:failure autoRetry:timesToRetry retryInterval:0];
}
...
- (NSURLSessionDataTask *)POST:(NSString *)URLString
     ...
     constructingBodyWithBlock:(void (^)(id <AFMultipartFormData> formData))block
                      progress:(nullable void (^)(NSProgress * _Nonnull))uploadProgress
                       ...
                       failure:(void (^)(NSURLSessionDataTask *task, NSError *error))failure
                     autoRetry:(int)timesToRetry {
    return [self POST:URLString parameters:parameters constructingBodyWithBlock:block progress:uploadProgress success:success failure:failure autoRetry:timesToRetry retryInterval:0];
}
...
- (nullable NSURLSessionDataTask *)GET:(NSString *)URLString
    ...
    return [self GET:URLString parameters:parameters progress:nil success:success failure:failure autoRetry:timesToRetry retryInterval:intervalInSeconds];
}
...
- (nullable NSURLSessionDataTask *)POST:(NSString *)URLString
                             parameters:(nullable NSDictionary *)parameters
                              ...
                              autoRetry:(int)timesToRetry
                          retryInterval:(int)intervalInSeconds DEPRECATED_ATTRIBUTE {
    return [self POST:URLString parameters:parameters progress:nil success:success failure:failure autoRetry:timesToRetry retryInterval:intervalInSeconds];
}
...
- (nullable NSURLSessionDataTask *)POST:(NSString *)URLString
              ...
              constructingBodyWithBlock:(nullable void (^)(id <AFMultipartFormData> formData))block
                              ...
                              autoRetry:(int)timesToRetry
                          retryInterval:(int)intervalInSeconds DEPRECATED_ATTRIBUTE {
    return [self POST:URLString parameters:parameters constructingBodyWithBlock:block progress:nil success:success failure:failure autoRetry:timesToRetry retryInterval:intervalInSeconds];
}
...
- (nullable NSURLSessionDataTask *)GET:(NSString *)URLString
                            parameters:(nullable NSDictionary *)parameters
                               success:(nullable void (^)(NSURLSessionDataTask *task, id _Nullable respo))success
                               failure:(nullable void (^)(NSURLSessionDataTask *task, NSError *error))failure
                             autoRetry:(int)timesToRetry DEPRECATED_ATTRIBUTE {
    return [self GET:URLString parameters:parameters progress:nil success:success failure:failure autoRetry:timesToRetry retryInterval:0];
}
...
- (nullable NSURLSessionDataTask *)POST:(NSString *)URLString
              ...
              constructingBodyWithBlock:(void (^)(id<AFMultipartFormData> _Nonnull))block
                              ...
                              autoRetry:(int)timesToRetry DEPRECATED_ATTRIBUTE {
    return [self POST:URLString parameters:parameters constructingBodyWithBlock:block progress:nil success:success failure:failure autoRetry:timesToRetry retryInterval:0];
}
...
- (nullable NSURLSessionDataTask *)POST:(NSString *)URLString
                             parameters:(id)parameters
                                ...
                                failure:(void (^)(NSURLSessionDataTask * _Nullable, NSError * _Nonnull))failure
                              autoRetry:(int)timesToRetry DEPRECATED_ATTRIBUTE {
    return [self POST:URLString parameters:parameters progress:nil success:success failure:failure autoRetry:timesToRetry retryInterval:0];
}
